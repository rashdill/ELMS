      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li><a href="home.php">Home</a></li>
			...
			<div class="login-box">
		<img src="img/employee2.jpg" class="avatar" alt="Image Not Found">
        <h2><b>Employee</b></h2>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-background"><img src="img/intro-carousel/employeelogin1.jpg" alt=""></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/employeelogin2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
